...
def install_packages(packages, install_path):
    for package in packages:
        subprocess.check_call([sys.executable, '-m', 'pip3', 'install', package, '-t', install_path, '--only-binary=:all:'])
...
def main():
    ...
    install_packages(packages, base_path)
